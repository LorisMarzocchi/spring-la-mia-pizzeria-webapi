...
INSERT INTO pizzas (nome, descrizione, prezzo, created_at) VALUES('Margherita', 'Pomodoro, mozzarella, basilico', 8, '2023-11-09 15:00:00');

INSERT INTO pizzas (nome, descrizione, prezzo, created_at) VALUES('Marinara', 'Pomodoro, aglio, origano', 7,'2023-11-09 15:05:00');

INSERT INTO pizzas (nome, descrizione, prezzo, created_at) VALUES('Quattro Stagioni', 'Pomodoro, mozzarella, funghi, prosciutto', 13, '2023-11-09 15:10:00');

INSERT INTO pizzas (nome, descrizione, prezzo, created_at) VALUES('Diavola', 'Pomodoro, mozzarella, salame piccante', 10,'2023-11-09 15:15:00');

INSERT INTO pizzas (nome, descrizione, prezzo, created_at) VALUES('Quattro Formaggi', 'Mozzarella, gorgonzola, parmigiano, pecorino', 11,  '2023-11-09 15:20:00');

INSERT INTO pizzas (nome, descrizione, prezzo, created_at) VALUES('Ortolana', 'Pomodoro, mozzarella, verdure grigliate', 9.5, '2023-11-09 15:25:00');

INSERT INTO pizzas (nome, descrizione, prezzo, created_at) VALUES('Funghi', 'Pomodoro, mozzarella, funghi champignon', 9,'2023-11-09 15:30:00');

INSERT INTO pizzas (nome, descrizione, prezzo, created_at) VALUES('Napoli', 'Pomodoro, mozzarella, acciughe', 10,'2023-11-09 15:35:00');

INSERT INTO pizzas (nome, descrizione, prezzo, created_at) VALUES('Bufalina', 'Pomodoro, mozzarella di bufala, basilico', 12, '2023-11-09 15:40:00');

INSERT INTO pizzas (nome, descrizione, prezzo, created_at) VALUES('Prosciutto e Funghi', 'Pomodoro, mozzarella, prosciutto cotto, funghi', 11.5, '2023-11-09 15:45:00');
